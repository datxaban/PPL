...
class Emitter():
    ...
    def getJVMType(self, inType):
        ...
        if typeIn is IntType:
            ...
            return "V"
        elif typeIn is ArrayPointerType or typeIn is ArrayType:
    ...
    *   @param toLabel the ending label  of the scope where the variable is active.
    ...
    def emitNEWARRAY(self, Type):
        return self.jvm.emitNEWARRAY(self.getFullType(Type)) if not type(Type) is StringType else self.jvm.emitANEWARRAY(self.getFullType(Type)) 
    ...
    *   @param isStatic <code>true</code> if the method is static; <code>false</code> otherwise.
    ...
    def emitMETHOD(self, lexeme, in_, isStatic, frame):
        ...
        # if type(in_) is list:
        #     for x in in_:
        #         newtemp = newtemp + self.getJVMType(x)
        # else:
        #     newtemp = self.getJVMType(in_)
        # return self.jvm.emitMETHOD(lexeme, newtemp, isStatic)
